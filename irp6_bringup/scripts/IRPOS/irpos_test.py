...
def irp6p_multi_trajectory():
	...
	result = irpos.move_along_motor_trajectory(motor_trajectory)
	...
	result = irpos.move_along_joint_trajectory(joint_trajectory)
	if (result.error_code != 0):
		return result
	...
	result = irpos.move_along_cartesian_trajectory(cartesianTrajectory)
	if (result.error_code != 0):
		return result
